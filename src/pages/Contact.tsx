        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">ישראל, רחוב הקליניקה 12, תל אביב (קומה 2)</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">ו׳: 09:00 - 14:00</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href="https://www.instagram.com/anushka.beauty.boutique/" className="text-accent underline-offset-4 hover:underline">@anushka.beauty.boutique</a>
                </div>
              </div>
            </div>
          ...
          <div className="aspect-square bg-surface rounded-3xl border border-border/50 flex flex-col items-center justify-center p-12 text-center shadow-inner overflow-hidden relative">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <h3 className="text-2xl font-bold italic">נינוחות, רוגע ותוצאות.</h3>
